                ...
                <div className="comparison-summary">
                  ...
                  <strong>
                    {compareResult.r1.value > compareResult.r2.value
                      ? 'La condición A presenta mayor crecimiento en ese tiempo.'
                      : compareResult.r1.value < compareResult.r2.value
                      ? 'La condición B presenta mayor crecimiento en ese tiempo.'
                      : 'Ambas condiciones presentan el mismo crecimiento en ese tiempo.'}
                  </strong>
                </div>
              </div>
            )}
